...
export const Contact = () => {
    return (
        ...
        <div className="left">
            ...
            <h2 style={{transform:"translate(20px,50px)",color:"green",fontSize:"50px"}}>Mobile-<img src={mobile} alt="Gmail" width="50px" style={{transform:"translate(1px,10px)"}}></img>:7355612109</h2>
        ...
        <div className="right">
        <h1 style={{transform:"translate(30px,100px)",color:"blue",fontFamily:"sans-serif",fontSize:"50px"}}>Aman Pal Singh Rana</h1>
        <h2 style={{transform:"translate(20px,50px)",color:"green",fontSize:"50px"}}>Mobile-<img src={mobile} alt="Gmail" width="50px" style={{transform:"translate(1px,10px)"}}></img>:7706059995</h2>
