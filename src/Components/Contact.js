...
export const Contact = () => {
    return (
        ...
        <div className="left">
            <h1 style={{transform:"translate(90px,100px)",color:"brown",fontFamily:"sans-serif",fontSize:"50px"}}>Mohammad Atif</h1>
            ...
            <img src={contact} alt="Gmail" width="300px" style={{transform:"translate(150px,30px)"}}></img>
        ...
        <div className="right">
        <h1 style={{transform:"translate(95px,100px)",color:"blue",fontFamily:"sans-serif",fontSize:"50px"}}>Aman Pal Singh Rana</h1>
        <h2 style={{transform:"translate(85px,50px)",color:"green",fontSize:"50px"}}>Mobile-<img src={mobile} alt="Gmail" width="50px" style={{transform:"translate(1px,10px)"}}></img>:7706059995</h2>
            <img src={contact1} alt="Gmail" width="250px" style={{transform:"translate(150px,30px)"}}></img>
            <a href="mailto:amanpalsinghrana27@gmail.com">
            <img src={gmail} alt="Gmail" width="50" style={{transform:"translate(-120px,100px)",cursor:"arrow"}}></img>
            </a>
            <a href="https://www.linkedin.com/in/aman-pal-singh-rana-180837203/">
            <img src={linkedin} alt="Gmail" width="50" style={{transform:"translate(0px,110px)",cursor:"arrow",display:"inline-block"}}></img>
            </a>
